...
class Ui_Main():
    def setupUi(self, Dialog):
        ...
        self.pushButton_2.clicked.connect(self.Set3)

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Dialog"))
        self.pushButton.setToolTip(_translate("Dialog", "<html><head/><body><p></p></body></html>"))
        ...
        self.label.setText(_translate("Dialog",
                                      "<html><head/><body><p align=\"center\"><span style=\" color:#ffffff;\">Основное меню</span></p></body></html>"))
