...
"text: white")
        ...
        #self.pushButton_2.clicked.connect(self.Set2)   //////Подключение окна редактирования (Ваня и Стас)
        #self.pushButton_4.clicked.connect(self.Set4)   ////// Подключение окна Просмотри (....)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "MainMenu"))
        ...
        self.pushButton_2.setText(_translate("Dialog", "Просмотр"))
        self.pushButton_4.setText(_translate("Dialog", "Редактировать"))
        self.label.setText(_translate("Dialog", "<html><head/><body><p align=\"center\"><span style=\" color:#ffffff;\">Основное меню</span></p></body></html>"))


    def Set(self):
        self.window=QtWidgets.QMainWindow()
        self.f= Glafwindow.Ui_Dialog()
